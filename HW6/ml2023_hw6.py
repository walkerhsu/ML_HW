...
# %% [markdown] {"id":"wLHSIArLcFK0"}
# ## Import Packages and Set Seeds


# %% [code] {"id":"LQnlc27k7Aiw","outputId":"122e675a-a91b-4fa3-d56f-1f6bb38bc094"}
import math
import copy
...
# %% [markdown] {"id":"Vt6JSKawk7_b"}
# Create dataset

# %% [code] {"id":"uuckjpW_k1LN"}
...
# %% [markdown] {"id":"buW6BaNga-XH"}
# ## Step 2: The backward process = U-Net
# 
# 

# %% [markdown] {"id":"iYw6u0nJXIWy"}
# Define some useful functions and U-Net

# %% [code] {"id":"DuJCCZ5dInQq"}
def exists(x):
...
# %% [markdown] {"id":"yWJUjFIHInQt"}
# Define Trainer: define the updating process

# %% [code] {"id":"Ed12NNXPtDon"}
...
# %% [code] {"id":"GkWpuU-2KzIL","outputId":"2215341d-4f7f-48c3-85ac-403e9ad2cb27"}
os.system(f"cd ./submission")
os.system(f"tar -zcf ../submission.tgz *.jpg")
os.system(f"cd ..")